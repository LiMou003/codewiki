  ...
  return (
    <div className="min-h-screen paper-texture flex flex-col">
      ...
      <div className="flex-1 p-4 md:p-8 flex flex-col gap-6 max-w-7xl mx-auto w-full">
        <main className="relative overflow-hidden rounded-2xl border border-[var(--border-color)] bg-gradient-to-br from-[var(--accent-primary)]/10 via-[var(--background)] to-[var(--background)] shadow-custom">
          ...
          <div className="relative grid lg:grid-cols-[1.15fr,1fr] gap-4 p-4 md:p-6 items-start">
            ...
            <form onSubmit={handleFormSubmit} className="space-y-2">
              <div className="flex gap-2 items-center">
                <input
                  ...
                  className="input-modern flex-1 pl-3 pr-3 py-2 text-[var(--foreground)] bg-[var(--background)] border border-[var(--border-color)] rounded-xl focus:border-[var(--accent-primary)] focus:ring-2 focus:ring-[var(--accent-primary)]/30 transition"
                />
                <button
                  type="submit"
                  className="btn-primary px-5 py-2 rounded-lg disabled:opacity-50 disabled:cursor-not-allowed whitespace-nowrap"
            ...
            <div className="space-y-0">
              <p className="text-xs uppercase tracking-wide text-[var(--muted)]">{hasExistingProjects ? t('') : t('home.welcomeTagline')}</p>
              <h1 className="text-xl md:text-2xl font-bold text-[var(--foreground)]">
                {hasExistingProjects ? t('projects.existingProjects') : t('')}
              </h1>
            </div>
            {hasExistingProjects ? (
              <ProcessedProjects
